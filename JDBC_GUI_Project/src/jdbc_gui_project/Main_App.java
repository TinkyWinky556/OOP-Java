...
public class Main_App extends JFrame implements ActionListener, ItemListener {
    ...
    public Main_App(){
        ...
        Search_Btn.setBounds(15, 482, 100, 30);
        Search_Btn.addActionListener(this);
        Search_Btn.setText("SEARCH BY ID");
        Search_Btn.setFont(new Font("Times New Roman", PLAIN, 12));
        Search_Btn.setFocusable(false);
        Search_Btn.setForeground(new Color(51, 255, 51));
        Search_Btn.setBackground(new Color(30, 34, 255));
        Search_Btn.setBorder(BorderFactory.createEtchedBorder());
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        */
            ...
            */
        ...
        else if(src == Search_Btn) { 
            Employee_TextArea.setText("");
            // Search A Record From Table By Employee_ID Reference.
            ...
            try {
                ...
                My_Prepared_St = My_Con.prepareStatement("select * from employee where employee_id=?");
                My_Prepared_St.setString(1, (String)Employee_ID_TextField.getText());
                
                My_Rs = My_Prepared_St.executeQuery();
                
                // Condition Checking.
                if(My_Rs.next()) { 
                    // Column Name Reference.
                    userData = "Employee_ID = " + My_Rs.getString("employee_id") + "\n" + "Full Name = " + My_Rs.getString("name") + "\n" + "Gender = " + My_Rs.getString("gender") + "\n" + "Address = " + My_Rs.getString("address") + "\n" + "Mobile Number = " + My_Rs.getString("mobile") + "\n" + "Date Employed = " + My_Rs.getString("date_employed") + "\n" + "Designation(Job Title) = " + My_Rs.getString("designation") + "\n" + "Monthly Salary(Payment Rate) = " + My_Rs.getString("monthly_payment_rate") + "\n" + "=====================================================================================================================";
